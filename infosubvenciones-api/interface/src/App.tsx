      ...
      <header className="topbar">
        ...
        <div className="topbar-right">
          ...
          <div className="designed-for">
            <span className="designed-for-small">Diseñado para</span>
            <span className="designed-for-brand">Artisting</span>
          </div>
        </div>
      </header>
        ...
        <main className="chat-panel">
          <div className="filters">
            <div className="filters-header">
              ...
              <p className="filters-description">Utiliza los filtros para encontrar subvenciones específicas o prueba los atajos rápidos</p>
            </div>

            <div className="filter-section">
              <h3 className="filter-section-title">Filtros básicos</h3>
              <div className="filter-fields">
                ...
                <div className="filter-input-group">
                  <label htmlFor="beneficiario">Tipo de beneficiario</label>
                  <input
                    id="beneficiario"
                    placeholder="ej: autónomos, pymes..."
                    value={filters.beneficiario ?? ""}
                    onChange={(e) => setFilters((f) => ({ ...f, beneficiario: e.target.value }))}
                  />
                </div>
                <div className="filter-input-group">
                  <label htmlFor="finalidad">Sector (Finalidad)</label>
                  <input
                    id="finalidad"
                    placeholder="11=Cultura, 14=Comercio"
            ...
            <div className="filter-section">
              <h3 className="filter-section-title">Plazo de solicitud</h3>
              <p className="filter-section-help">Filtra por fecha límite para solicitar las ayudas</p>
              <div className="filter-fields filter-fields-dates">
                <div className="filter-input-group">
                  <label htmlFor="fechaDesde">Plazo desde</label>
                  <input
                    id="fechaDesde"
                    type="date"
                ...
                <div className="filter-input-group">
                  <label htmlFor="fechaHasta">Plazo hasta</label>
                  <input
                    id="fechaHasta"
                    type="date"
            ...
            <div className="filter-section">
              <h3 className="filter-section-title">Cuantía de la ayuda (€)</h3>
              <div className="filter-fields filter-fields-cuantia">
                <div className="filter-input-group">
                  <label htmlFor="cuantiaMin">Mínimo</label>
                  <input
                    id="cuantiaMin"
                    placeholder="0"
                    type="number"
                ...
                <div className="filter-input-group">
                  <label htmlFor="cuantiaMax">Máximo</label>
                  <input
                    id="cuantiaMax"
            ...
            <div className="filter-section">
              <h3 className="filter-section-title">Atajos rápidos</h3>
              <div className="chips">
                {presets.map((p) => (
                  <button
                    key={p.label}
              ...
              <div className="applied-filters">
                <strong>Filtros activos:</strong> {appliedFiltersLine}
              </div>
            </div>
          </div>
